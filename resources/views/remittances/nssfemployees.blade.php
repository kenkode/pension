                       ...
                       <div class="alert alert-success">
                        ...
                        <div class="panel panel-default">
                          <div class="panel-heading">
                            @if(App\Remittedemployee::getCount($period,'nssf') < $emps)
                            <a class="btn btn-info btn-sm" href="{{ URL::to('remitnssf/finalize/'.$id)}}">Finalize Remittance</a>
                            @endif
                            <a class="btn btn-warning btn-sm" href="{{ URL::to('remitnssf')}}">Go Back</a>
                          </div>
                  ...
                  <div class="table-responsive">
                    ...
                    @foreach ($remittedemployees as $remittedemployee)
                      ...
                      <tr>
                          ...
                          <td>Ksh. {{ number_format(App\Transact::getNssf($remittedemployee->employee_id,$period),2) }}</td>
