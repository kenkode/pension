...
<div class="row">
    ...
    @endif
        ...
        @endif
		 ...
		 <form method="POST" action="{{{ URL::to('remitnhif/finalizenhifupdate/'.$id) }}}" accept-charset="UTF-8">
   {{ csrf_field() }}
    <fieldset>
      ...
      <div class="form-group">
       ...
       @if(App\Remittedemployee::getEmployee($employee->id,$period,'nhif') == $employee->id)
