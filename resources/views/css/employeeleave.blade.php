...
<div class="row">
  ...
  <table class="table table-responsive table-bordered table-condensed">
   ...
   <td><strong>Applied End Date</strong></td><td>{{date('d-M-Y', strtotime($leaveapplication->applied_end_date))}}</td>
    ...
    <tr>
   <td><strong>Leave Days</strong></td><td>{{App\Leaveapplication::getDays($leaveapplication->applied_end_date,$leaveapplication->applied_start_date,$leaveapplication->is_weekend,$leaveapplication->is_holiday)+1}}</td>
