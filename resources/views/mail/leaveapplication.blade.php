...
<tbody>
	...
	<tr>
		<td>Leave Type</td><td>{{App\Leavetype::getName($application->leavetype_id)}}</td>
	</tr>
	<tr>
	...
	<tr>
		<td>Days</td><td>{{App\Leaveapplication::getDays($application->applied_end_date,$application->applied_start_date,$application->is_weekend,$application->is_holiday)+1}}</td>
     </tr>
