...
<a class="btn btn-danger btn-sm "  href="{{URL::to('employee_relief/delete/'.$rel->id)}}" onclick="return (confirm('Are you sure you want to delete this employee`s relief?'))">Delete</a>
<a class="btn btn-success btn-sm "  href="{{ URL::to('employee_relief')}}">Go Back</a>
<hr>
</div>	
</div>
...
<img src="{{asset('/uploads/employees/photo/'.$rel->photo) }}" width="150px" height="130px" alt=""><br>
<br>
<img src="{{asset('/uploads/employees/signature/'.$rel->signature) }}" width="120px" height="50px" alt="">
</div>
